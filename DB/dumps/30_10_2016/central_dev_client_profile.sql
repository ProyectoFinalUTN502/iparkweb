...
CREATE TABLE `client_profile` (
  ...
  `is24` int(11) NOT NULL DEFAULT '0',
  `isCovered` int(11) NOT NULL DEFAULT '0',
  `creationDate` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `client_id` int(11) NOT NULL,
  PRIMARY KEY (`id`),
  KEY `fk_client_profile_client1_idx` (`client_id`),
  CONSTRAINT `fk_client_profile_client1` FOREIGN KEY (`client_id`) REFERENCES `client` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
INSERT INTO `client_profile` VALUES (1,9,1100,0,0,'2016-09-11 23:35:26',1),(2,10,100,0,0,'2016-10-21 19:23:58',3),(3,5,200,0,0,'2016-10-21 19:32:46',4);
