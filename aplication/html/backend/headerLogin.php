...
<html class="no-js">
    <head>
        ...
        <link rel="stylesheet" href="/<?php echo $base; ?>/aplication/public/backend/css/Login.css" type="text/css" />
        ...
        <script type="text/javascript"  src="../public/backend/js/App.js"></script>
        <script type="text/javascript"  src="../public/backend/js/Login.js"></script>
        <!-- -- -->
    </head>
