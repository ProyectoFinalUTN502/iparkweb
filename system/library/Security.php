...
require_once (LIBRARYPATH . DS . "security" . DS . "IHash.php");
require_once (LIBRARYPATH . DS . "security" . DS . "HAVALL1160_4.php");
require_once (LIBRARYPATH . DS . "security" . DS . "MD5.php");
require_once (LIBRARYPATH . DS . "security" . DS . "SHA256.php");
